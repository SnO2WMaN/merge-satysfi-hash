...
export type WS = WS_1 | WS_2 | WS_3 | WS_4;
export type WS_1 = string;
export type WS_2 = string;
export type WS_3 = string;
export type WS_4 = string;
export type Quot = Quot_1 | Quot_2;
export interface Quot_1 {
    kind: ASTKinds.Quot_1;
    actual: string;
}
export interface Quot_2 {
    kind: ASTKinds.Quot_2;
    actual: string;
}
...
export class Parser {
    ...
    public matchWS($$dpth: number, $$cr?: ErrorTracker): Nullable<WS> {
        return this.choice<WS>([
            () => this.matchWS_1($$dpth + 1, $$cr),
            () => this.matchWS_2($$dpth + 1, $$cr),
            () => this.matchWS_3($$dpth + 1, $$cr),
            () => this.matchWS_4($$dpth + 1, $$cr),
        ]);
    }
    public matchWS_1($$dpth: number, $$cr?: ErrorTracker): Nullable<WS_1> {
        return this.regexAccept(String.raw`(?: )`, $$dpth + 1, $$cr);
    }
    public matchWS_2($$dpth: number, $$cr?: ErrorTracker): Nullable<WS_2> {
        return this.regexAccept(String.raw`(?:\t)`, $$dpth + 1, $$cr);
    }
    public matchWS_3($$dpth: number, $$cr?: ErrorTracker): Nullable<WS_3> {
        return this.regexAccept(String.raw`(?:\r)`, $$dpth + 1, $$cr);
    }
    public matchWS_4($$dpth: number, $$cr?: ErrorTracker): Nullable<WS_4> {
        return this.regexAccept(String.raw`(?:\n)`, $$dpth + 1, $$cr);
    }
    public matchQuot($$dpth: number, $$cr?: ErrorTracker): Nullable<Quot> {
        return this.choice<Quot>([
            () => this.matchQuot_1($$dpth + 1, $$cr),
            () => this.matchQuot_2($$dpth + 1, $$cr),
        ]);
    }
    public matchQuot_1($$dpth: number, $$cr?: ErrorTracker): Nullable<Quot_1> {
        return this.run<Quot_1>($$dpth,
            () => {
                let $scope$actual: Nullable<string>;
                let $$res: Nullable<Quot_1> = null;
                if (true
                    && this.regexAccept(String.raw`(?:")`, $$dpth + 1, $$cr) !== null
                    && ($scope$actual = this.regexAccept(String.raw`(?:[a-zA-Z0-9_\-\/\.]*)`, $$dpth + 1, $$cr)) !== null
                    && this.regexAccept(String.raw`(?:")`, $$dpth + 1, $$cr) !== null
                ) {
                    $$res = {kind: ASTKinds.Quot_1, actual: $scope$actual};
                }
                return $$res;
            });
    }
    public matchQuot_2($$dpth: number, $$cr?: ErrorTracker): Nullable<Quot_2> {
        return this.run<Quot_2>($$dpth,
            () => {
                let $scope$actual: Nullable<string>;
                let $$res: Nullable<Quot_2> = null;
                if (true
                    && ($scope$actual = this.regexAccept(String.raw`(?:[a-zA-Z0-9_\-\/\.]*)`, $$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.Quot_2, actual: $scope$actual};
                }
                return $$res;
            });
    }
